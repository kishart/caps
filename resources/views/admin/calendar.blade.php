      ...
      <ul class="space-y-2 font-medium">
        <li class="hover-color-custom">
          <a href="{{ asset('booklist') }}" class="flex items-center p-2 font-color-custom group group-hover-custom">
            <span class="material-symbols-rounded color-custom group group-hover-custom" aria-hidden="true">today</span>
        ...
        <li>
          <a href="{{ asset('uphotos') }}" class="flex items-center p-2 font-color-custom group group-hover-custom">
            <span class="material-symbols-rounded color-custom group group-hover-custom" aria-hidden="true">publish</span>
        ...
        <li>
          <a href="{{ asset('calendar') }}" class="flex items-center p-2 font-color-custom group group-hover-custom">
            <span class="material-symbols-rounded color-custom group group-hover-custom" aria-hidden="true">calendar_month</span>
            <span class="flex-1 ms-3 whitespace-nowrap">Calendar</span>
          </a>
        </li>
        <li>
          <a href="{{ asset('msg') }}" class="flex items-center p-2 font-color-custom group group-hover-custom">
            <span class="material-symbols-rounded color-custom group group-hover-custom" aria-hidden="true">sms</span>
            <span class="flex-1 ms-3 whitespace-nowrap">Message</span>
          </a>
        </li>
        <li>
          <a href="{{ asset('msg') }}" class="flex items-center p-2 font-color-custom group group-hover-custom">
            <span class="material-symbols-rounded color-custom group group-hover-custom" aria-hidden="true">logout</span>
    ...
    $(document).ready(function() {
      ...
      $('#calendar').fullCalendar({
        ...
        eventRender: function(event, element) {
          ...
          if (event.note) {
            element.find('.fc-title').append(event.note);
          }
        }
      });
    });

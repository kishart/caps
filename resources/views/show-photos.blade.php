        ...
        @else
            ...
            @foreach ($photoUploads as $upload)
                @php
                    ...
                    $photoPaths = json_decode($upload->photo_paths, true);
                @endphp
                
                <div id="carousel-{{ $upload->id }}" class="carousel slide mb-5" data-bs-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carousel-{{ $upload->id }}" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carousel-{{ $upload->id }}" data-bs-slide="next">

...
function showDiv(target) {
    const uploadDiv = document.getElementById('uploadPhotosDiv');
    const listDiv = document.getElementById('listPhotosDiv');
    const toggleCheckbox = document.getElementById('toggle');

    if (target === 'upload-photos') {
        uploadDiv.style.display = 'block';
        listDiv.style.display = 'none';
        toggleCheckbox.checked = false; // Set toggle to Upload Photos
    } else if (target === 'list-photos') {
        uploadDiv.style.display = 'none';
        listDiv.style.display = 'block';
        toggleCheckbox.checked = true; // Set toggle to List Photos
    }
}

// Ensure toggle remains responsive to manual changes
document.getElementById('toggle').addEventListener('change', function () {
    if (this.checked) {
        showDiv('list-photos');
    } else {
        showDiv('upload-photos');
    }
});
